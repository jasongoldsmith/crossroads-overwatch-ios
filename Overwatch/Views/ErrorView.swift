...
@objc protocol ErrorViewProtocol {
    @objc optional func addActivity (eventInfo: EventInfo?)
    @objc optional func addConsole ()
    @objc optional func goToBungie (eventID: String?)
}
...
class ErrorView: UIView {
    ...
    @IBAction func buttonOneYesPressed (sender: UIButton) {
        ...
        case .ACTIVITY_NOT_AVAILABLE:
            self.delegate?.addActivity!(eventInfo: self.eventInfo)
            break
        ...
        case .JOIN_BUNGIE_GROUP:
            self.delegate?.goToBungie!(eventID: self.eventInfo?.eventClanID)
            break
        }
    ...
    override func layoutSubviews() {
        ...
        self.buttonTwoCancel.isHidden = false
